...
function Topics() {
  ...
  return (
    <div>
      ...
      <div className="grid-container topic-grid-container" style={{ marginBottom: '30px' }}>
            ...
            case 'Lifestyle and Daily Experiences':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item1"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
                  ...
                  <div style={{ height: '50%', margin: 'auto', marginTop: '5%' }}>
                    <img
                      ...
                      alt="lifestyle and daily experiences icon"
                    />
                  </div>
                </div>
              );
            case 'Health and Wellness':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item2 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
                    <img
                      style={{
                        order: 1, maxWidth: '35%', height: 'auto', paddingRight: '3%',
                      }}
                    ...
                    <p
                      ...
                      style={{
                        order: 2, display: 'flex', width: '30%', paddingLeft: '3%',
                      }}
                    >
                      Health and Wellness
                    </p>
            ...
            case 'Food and Cooking':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item3 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
            ...
            case 'Travel and Adventure':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item4"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
            ...
            case 'Parenting and Family':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item5"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
            ...
            case 'Technology and Gadgets':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item6 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
                    <img
                      style={{
                        order: 1, maxWidth: '25%', height: 'auto', paddingRight: '3%',
                      }}
            ...
            case 'Art and Creativity':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item7"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
                  ...
                  <div style={{
                    display: 'flex', alignItems: 'center', height: '80%', margin: 'auto',
                  }}
                  >
                    <img
                      style={{ width: '80%', margin: 'auto' }}
                      src={artAndCreativity}
                      alt="art and creativity icon"
                    />
                  </div>
                </div>
              );
            case 'Relationships and Dating':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item8"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
            ...
            case 'Inspiration and Motivation':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item9"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
                  ...
                  <div
                    style={{
                      height: '50%', margin: 'auto', marginTop: '4%',
                    }}
                  >
                    <img
                      style={{ height: '100%' }}
            ...
            case 'Career and Professional Life':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item10 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
            ...
            case 'Education and Learning':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item11 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
                    <img
                      style={{
                        order: 1, maxWidth: '30%', height: 'auto', paddingRight: '3%',
                      }}
            ...
            case 'Hobbies and Interests':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item12"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
            ...
            case 'Entertainment and Pop Culture':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item13 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr">
                    <img
                      style={{
                        order: 1, maxWidth: '35%', height: 'auto', paddingLeft: '8%',
                      }}
                      src={entertainmentAndPopCulture}
                      alt="Entertainment and Pop Culture icon"
                    />
                    <p
                      className="topic-grid-title-font"
                      style={{
                        order: 2, display: 'flex', width: '30%', paddingLeft: '5%',
                      }}
                    >
            ...
            case 'Sports and Fitness':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item14 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
                    <img
                      style={{
                        order: 1, maxWidth: '40%', height: 'auto', paddingRight: '3%',
                      }}
            ...
            case 'Home and DIY':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item15"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
            ...
            case 'Politics and Religion':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item16"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
            ...
            case 'Finance and Money':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item17"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <p
            ...
            case 'Community and Social Causes':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item18 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
                    <img
                      ...
                      alt="Community and Social Causes icon"
                    />
                    <p
                      className="topic-grid-title-font"
            ...
            case 'Fiction and Creative Writing':
              return (
                <div
                  ...
                  role="link"
                  tabIndex={0}
                  className="grid-item topic-user-area-grid-item topic-item19 dis-flex-al-ctr"
                  onClick={() => navigate(`/articles?topic=${name}`)}
                  onKeyDown={() => navigate(`/articles?topic=${name}`)}
                >
                  <div className="dis-flex-al-ctr" style={{ justifyContent: 'center' }}>
                    <img
                      ...
                      alt="Fiction and Creative Writing icon"
                    />
                    <p
                      className="topic-grid-title-font"
                      style={{
